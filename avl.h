...
static INLINE void _avl_rotate_ll(avl_root_t *rootp, avl_item_t *itemp) {
  ...
  if (itemp->ai_left) itemp->ai_left->ai_up = itemp;
  tmp->ai_right = itemp;
...
static INLINE void _avl_rotate_lr(avl_root_t *rootp, avl_item_t *itemp) {
  ...
  if (rcp->ai_right) rcp->ai_right->ai_up = rcp;
...
static INLINE void _avl_rotate_rr(avl_root_t *rootp, avl_item_t *itemp) {
  ...
  if (itemp->ai_right) itemp->ai_right->ai_up = itemp;
  tmp->ai_left = itemp;
...
static INLINE void _avl_rotate_rl(avl_root_t *rootp, avl_item_t *itemp) {
  ...
  if (rcp->ai_left) rcp->ai_left->ai_up = rcp;
...
static void avl_delete_fix(avl_root_t *rootp, avl_item_t *itemp,
  ...
  while (parentp) {
	...
	if (itemp->ai_balance == LEFT) {
	  ...
	  itemp->ai_balance = CENT;
	  parentp->ai_balance = CENT;
	  if (childp->ai_balance == RIGHT) itemp->ai_balance = LEFT;
	  if (childp->ai_balance == LEFT) parentp->ai_balance = RIGHT;
	...
	if (itemp->ai_balance == RIGHT) {
	  ...
	  itemp->ai_balance = CENT;
	  parentp->ai_balance = CENT;
	  if (childp->ai_balance == RIGHT) parentp->ai_balance = LEFT;
	  if (childp->ai_balance == LEFT) itemp->ai_balance = RIGHT;
	  childp->ai_balance = CENT;
	  parentp = childp;
	}
      } else if (parentp->ai_balance == CENT) {
...
static INLINE avl_item_t *avl_first(avl_root_t *rootp) {
  ...
  if (itemp) {
    while (itemp->ai_left) itemp = itemp->ai_left;
  }
  return itemp;
}
...
static void avl_remove(avl_root_t *rootp, avl_item_t *itemp) {
  ...
  if ((itemp->ai_left == NULL) || (itemp->ai_right == NULL)) {
    ...
    if (replacep == NULL) replacep = itemp->ai_right;
    if (replacep != NULL) replacep->ai_up = parentp;
    if (parentp == NULL) {
  ...
  if (relocp->ai_left != NULL) relocp->ai_left->ai_up = relocp;
  if (itemp->ai_up == NULL)
  ...
  if (relocp == relocp->ai_up->ai_left) {
    ...
    if (replacep != NULL) replacep->ai_up = relocp->ai_up;
  ...
  if (relocp->ai_right != NULL) relocp->ai_right->ai_up = relocp;
